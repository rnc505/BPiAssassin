...
#ifndef BPiAssassin_BPNotifications_h
#define BPiAssassin_BPNotifications_h

static NSString * const kUserRegisteredNotification = @"kUserRegisteredNotification";
static NSString * const kGameCreatedNotification = @"kGameCreatedNotification";
static NSString * const kGameStartedNotification = @"kGameStartedNotification";
